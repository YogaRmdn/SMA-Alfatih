    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,p,br,hr,strong,b,em,i,u,s,del,ins,sub,sup,mark,blockquote,pre,code,ul,ol,li,a[href|title|target|rel],img[src|alt|title|width|height],span,div,table,thead,tbody,tfoot,tr,th[colspan|rowspan],td[colspan|rowspan]',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form,input,select,option,textarea,button,link,meta,base,canvas,audio,video,source,track,svg,math,frame,frameset',
